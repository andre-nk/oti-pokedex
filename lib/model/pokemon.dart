...
//? Custom Pokemon model for fetching '/pokemons/xxx' route on PokeAPI
...
class Pokemon {
  ...
  //? Get custom colors from each types available
  List<Color> getTypeColors() {
    List<Color> typeColors = [];

    for (var type in types) {
      switch (type.type.name) {
        case "normal": typeColors.add(const Color(0xFFACA875));
          break;
        case "fire": typeColors.add(const Color(0xFFFC0B0C));
          break;
        case "water": typeColors.add(const Color(0xFF0C79BC));
          break;
        case "electric": typeColors.add(const Color(0xFFFFFA24));
          break;
        case "grass": typeColors.add(const Color(0xFF3F960C));
          break;
        case "ice": typeColors.add(const Color(0xFF64CFE5));
          break;
        case "fighting": typeColors.add(const Color(0xFF800D11));
          break;
        case "poison": typeColors.add(const Color(0xFF611381));
          break;
        case "ground": typeColors.add(const Color(0xFFE1C46A));
          break;
        case "flying": typeColors.add(const Color(0xFF075664));
          break;
        case "psychic": typeColors.add(const Color(0xFFEA0F63));
          break;
        case "bug": typeColors.add(const Color(0xFF91BA2E));
          break;
        case "rock": typeColors.add(const Color(0xFF474026));
          break;
        case "ghost": typeColors.add(const Color(0xFF472B53));
          break;
        case "dragon": typeColors.add(const Color(0xFF29036A));
          break;
        case "dark": typeColors.add(const Color(0xFF2D221C));
          break;
        case "steel": typeColors.add(const Color(0xFF454445));
          break;
        case "fairy": typeColors.add(const Color(0xFFF87CA7));
          break;
        default:
      }
    }
